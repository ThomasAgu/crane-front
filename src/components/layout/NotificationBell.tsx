    ...
    <div className="w-full relative shrink-0" ref={dropdownRef}>
      ...
      >
        <div className="relative flex items-center justify-center h-[50px] w-[50px] shrink-0">
          ...
          {unreadCount > 0 && (
            <span className="absolute top-1 right-1 bg-red-500 text-white text-[11px] font-bold rounded-full h-5 w-5 flex items-center justify-center border-2 border-slate-900">
              {unreadCount}
            </span>
          )}
        </div>
